...
//   const handlePlanSelection = (plan: GymPlan) => {
//     setSelectedPlan(plan);
//     if (startDate) {
//       const newEndDate = getEndDate(startDate, plan);
//       setEndDate(newEndDate);
//       setHighlightedDates(getHighlightedDates(startDate, newEndDate));
//     }
//   };
...
//     setStartDate(date);
//     if (selectedPlan) {
//       const newEndDate = getEndDate(date, selectedPlan);
//       setEndDate(newEndDate);
//       setHighlightedDates(getHighlightedDates(date, newEndDate));
//     }
//   };
...
//   // Modify the DatePicker section in the return JSX
...
//           ) ? "bg-green-50 rounded-full" : undefined
//         }
//       />
//       {endDate && (
...
//                 onClick={() => setCurrentImageIndex(index)}
//                 className={`h-2 w-2 rounded-full transition-all duration-300 
//                   ${index === currentImageIndex ? 'bg-black w-6' : 'bg-gray-300'}`}
//               />
//             ))}
//           </div>
//         </div>
...
//                     target="_blank" 
//                     rel="noreferrer" 
//                     className="ml-4 text-gray-600 hover:text-black text-sm flex items-center"
//                   >
//                     View Location
//                   </a>
//                 )}
...
export default function GymDetailsPage() {
  ...
  const handleBooking = async () => {
    ...
    try {
      const bookingId: string = await bookingService.createBooking(
        user.uid,
        gym?.id as string,
        selectedPlan,
        startDate,
